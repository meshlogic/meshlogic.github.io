...
# This is the URL where Nikola's output will be deployed. If not set, defaults to SITE_URL
...
# to feeds and are considered part of a blog, while PAGES are just independent HTML pages.
#
POSTS = (
...
# "source/" and the results will be located in "OUTPUT_PATH/relative_destination/gallery_name"
#
...
TRANSLATIONS = {
    DEFAULT_LANG: "",
    # Example for another language: # "es": "./es",
}
